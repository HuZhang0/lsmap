 ...
 * Private functions                                                          *
 ******************************************************************************/
aig2xmg_manager::aig2xmg_manager(aig_network aig) : aig(aig) {}
...
xmg_network aig2xmg_manager::run() {
  ...
  /* create pis */
  aig.foreach_pi([&](auto n) { node2new[n] = xmg.create_pi(); });
  ...
  aig_topo.foreach_node([&](auto n) {
    ...
    aig.foreach_fanin(n, [&](auto const& f) {
      children.push_back(aig.is_complemented(f) ? xmg.create_not(node2new[f])
                                                : node2new[f]);
    });
  ...
  aig.foreach_po([&](auto const& f, auto index) {
    auto const o =
        aig.is_complemented(f) ? xmg.create_not(node2new[f]) : node2new[f];
    xmg.create_po(o);
  });
...
xag_network aig2xag_manager::run() {
  ...
  /* create pis */
  aig.foreach_pi([&](auto n) { node2new[n] = xag.create_pi(); });
...
// mig to xmg
mig2xmg_manager::mig2xmg_manager(mig_network mig) : mig(mig) {}
...
xmg_network mig2xmg_manager::run() {
  ...
  /* create pis */
  mig.foreach_pi([&](auto n) { node2new[n] = xmg.create_pi(); });
  ...
  mig_topo.foreach_node([&](auto n) {
    ...
    mig.foreach_fanin(n, [&](auto const& f) {
      children.push_back(mig.is_complemented(f) ? xmg.create_not(node2new[f])
                                                : node2new[f]);
    });
  ...
  mig.foreach_po([&](auto const& f, auto index) {
    auto const o =
        mig.is_complemented(f) ? xmg.create_not(node2new[f]) : node2new[f];
    xmg.create_po(o);
  });
...
// xmg to mig
xmg2mig_manager::xmg2mig_manager(xmg_network xmg) : xmg(xmg) {}
...
mig_network xmg2mig_manager::run() {
  ...
  /* create pis */
  xmg.foreach_pi([&](auto n) { node2new[n] = mig.create_pi(); });
  ...
  xmg_topo.foreach_node([&](auto n) {
    ...
    xmg.foreach_fanin(n, [&](auto const& f) {
      children.push_back(xmg.is_complemented(f) ? mig.create_not(node2new[f])
                                                : node2new[f]);
    });
    ...
    if (xmg.is_maj(n)) {
      ...
      // xor3
      auto minority =
          mig.create_not(mig.create_maj(children[0], children[1], children[2]));
      node2new[n] =
          mig.create_maj(children[2], minority,
  ...
  xmg.foreach_po([&](auto const& f, auto index) {
    auto const o =
        xmg.is_complemented(f) ? mig.create_not(node2new[f]) : node2new[f];
    mig.create_po(o);
  });
