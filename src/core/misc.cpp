...
std::vector<std::vector<unsigned>> get_all_combination_index(
    std::vector<unsigned>& vars, const unsigned& n, const unsigned& k) {
...
std::vector<std::vector<unsigned>> get_all_permutation(
...
void print_sat_clause(solver_wrapper* solver, pabc::lit* begin,
                      pabc::lit* end) {
  printf("Add clause:  ");
  pabc::lit* i;
...
int add_print_clause(std::vector<std::vector<int>>& clauses, pabc::lit* begin,
                     pabc::lit* end) {
...
void to_dimacs(FILE* f, solver_wrapper* solver,
